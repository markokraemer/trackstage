...
export const MessageResponse = memo(
  ({ className, ...props }: MessageResponseProps) => (
    <Streamdown
      className={cn(
        // `w-full`, NOT the upstream `size-full`: `h-full` is a
        // percentage-height child inside the message flex column, which made
        // Chrome resolve the column at a bogus definite height — and the
        // shortfall was absorbed by the overflow-hidden tool cards, clipping
        // them mid-list (Marko's screenshots, 2026-08-11). Prose height must
        // always be its content's height.
