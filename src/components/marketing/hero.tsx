...
export function Hero() {
  return (
    <section className="relative w-full overflow-hidden border-b border-border/70 bg-card px-4 pt-16 pb-16 sm:px-6 sm:pt-24 sm:pb-24">
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <h1 className="font-heading mt-6 text-4xl leading-[1.08] font-semibold tracking-tight text-balance text-foreground sm:text-5xl lg:text-6xl">
          ...
          <div className="mt-9 flex w-full flex-col items-stretch justify-center gap-2.5 sm:w-auto sm:flex-row sm:items-center">
            <Button size="lg" className="px-4" render={<Link to="/login" />}>
              Get started free
