...
export function Ripple({
  ...
  disabled = false,
  max = 4,
  tintClassName = "bg-foreground/15",
  className = "",
}: RippleProps) {
  ...
  return (
    <button
      ...
      className={`relative isolate inline-flex items-center justify-center gap-2 rounded-md border border-border bg-card px-3.5 py-2 text-[13px] font-medium text-foreground outline-none select-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 ${className}`}
      {...bind}
    >
      <span
        aria-hidden
