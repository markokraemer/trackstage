...
export function LongPressButton({
  ...
  return (
    <motion.button
      ...
      className={`group relative inline-flex h-9 items-center rounded-md border px-3.5 text-[13px] font-medium transition-[border-color,background-color,box-shadow,transform] duration-150 outline-none select-none focus-visible:border-ring focus-visible:shadow-[0_1px_2px_rgba(27,30,39,0.08),0_10px_20px_-14px_rgba(47,92,224,0.6)] ${
        holding
          ? "translate-y-px border-border bg-muted/70 shadow-[inset_0_1px_2px_rgba(27,30,39,0.07)]"
          : fired
            ? "border-ring bg-primary/[0.07]"
            : "border-border bg-card shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(27,30,39,0.06),0_1px_2px_rgba(27,30,39,0.08)] hover:bg-secondary"
