        ...
        {filters.map((filter, i) => {
          ...
          return (
            <button
              ...
              className="group relative inline-grid h-8 place-items-center rounded-[6px] px-3 outline-none select-none focus-visible:shadow-[0_1px_3px_rgba(27,30,39,0.18)]"
            ...
            >
              ...
              <span
                aria-hidden
                className={`pointer-events-none absolute inset-0 rounded-[6px] border group-focus-visible:border-ring ${
              ...
              <span className="relative col-start-1 row-start-1 inline-grid">
                <motion.span
                  ...
                  transition={swap}
                  className="col-start-1 row-start-1 inline-flex items-center gap-1.5 text-[12.5px] font-medium whitespace-nowrap text-foreground"
                >
                  {filter.label}
                ...
                <motion.span
                  ...
                  transition={swap}
                  className="col-start-1 row-start-1 inline-flex items-center gap-1.5 text-[12.5px] font-medium whitespace-nowrap text-background"
                >
                  {filter.label}
          ...
          >
            {visible.map((item) => (
              <motion.li
                ...
                transition={step}
                className="min-w-0 overflow-hidden rounded-lg border border-border bg-card p-2.5 shadow-[0_1px_2px_rgba(27,30,39,0.06),0_4px_10px_-8px_rgba(27,30,39,0.45)]"
              >
                {renderItem(item)}
              </motion.li>
            ))}
