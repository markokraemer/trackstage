...
export function SortableTable<T>({
  ...
  return (
    <div
      className={`overflow-hidden rounded-xl border border-border bg-card shadow-[0_1px_2px_rgba(27,30,39,0.06),0_4px_10px_-8px_rgba(27,30,39,0.45)] ${className}`}
    >
      <div
        role="table"
        aria-label={label}
              ...
              return (
                ...
                >
                  {column.sortable === false ? (
                    <span
                      className={`block truncate px-1.5 text-[11px] font-semibold tracking-[0.08em] text-muted-foreground uppercase ${
                        end ? "text-right" : ""
                      }`}
                    >
                      {column.header}
                    ...
                    <button
                      ...
                      className={`group flex h-7 w-full items-center gap-1.5 rounded-[6px] px-1.5 outline-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)] ${
                ...
                {markable && (
                  <div role="cell" className="min-w-0">
                    <button
                      ...
                      onClick={() => onMark(id)}
                      className={`flex size-[18px] items-center justify-center rounded-[5px] border outline-none focus-visible:border-ring focus-visible:shadow-[0_1px_3px_rgba(27,30,39,0.18)] ${
                        marked === id
