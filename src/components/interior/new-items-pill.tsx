      ...
      <AnimatePresence initial={false}>
        {count > 0 && (
          <motion.button
            ...
            className="pointer-events-auto inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-card pr-2.5 pl-2 text-[12.5px] font-medium text-foreground shadow-[0_1px_2px_rgba(27,30,39,0.08),0_6px_14px_-10px_rgba(27,30,39,0.45)] transition-[border-color,box-shadow] duration-150 outline-none select-none focus-visible:border-ring focus-visible:shadow-[0_2px_4px_rgba(27,30,39,0.1),0_12px_22px_-12px_rgba(47,92,224,0.55)]"
          >
            <svg
              width="14"
              height="14"
