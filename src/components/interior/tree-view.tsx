...
export function TreeView({
      ...
      return (
        <li key={node.id} role="none">
          <div
            ...
            className={`flex h-7 cursor-default items-center gap-1 rounded-md px-1.5 transition-colors duration-150 outline-none select-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)] ${
              isSelected
          ...
          {row.branch ? (
            <AnimatePresence initial={false}>
              {row.open ? (
                ...
                >
                  <div className="ml-[13px] border-l border-border/80 pl-[7px]">
  ...
  return (
    <div
      className={`rounded-xl border border-border bg-card p-[5px] shadow-[0_1px_2px_rgba(27,30,39,0.06),0_4px_10px_-8px_rgba(27,30,39,0.45)] ${className}`}
    >
