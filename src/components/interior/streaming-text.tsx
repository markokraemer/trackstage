...
export function StreamingText({
  ...
  const caret = (
    ...
    >
      <motion.span
        className="absolute inset-y-0 left-px block w-[2px] bg-foreground"
        initial={false}
      ...
      {showSkip ? (
        <div className="mt-2.5 flex justify-end">
          <button
            ...
            className="inline-grid h-7 place-items-center rounded-[6px] border border-border px-2.5 text-[11.5px] font-medium text-muted-foreground transition-colors duration-150 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
          >
            <motion.span
              aria-hidden
