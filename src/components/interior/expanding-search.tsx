    ...
    >
      <motion.div
        ...
        className={`absolute inset-y-0 ${
          ...
          focused
            ? "border-ring bg-card"
            : "border-border bg-muted/70 shadow-[inset_0_1px_2px_rgba(27,30,39,0.07)]"
        }`}
      >
        <motion.input
          {...inputProps}
          ...
          className="absolute inset-y-0 bg-transparent text-[13px] leading-9 text-foreground outline-none placeholder:text-muted-foreground/70 focus-visible:outline-none [&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-decoration]:appearance-none"
        />
        ...
        >
          {resultCount === undefined ? null : (
            <span
              aria-hidden
              className="w-8 truncate text-right font-mono text-[9.5px] text-muted-foreground tabular-nums"
            >
              {filled ? resultCount : ""}
            </span>
          )}
          ...
          <motion.button
            ...
            className={`grid size-[22px] place-items-center rounded-[6px] text-muted-foreground outline-none focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-[var(--primary)] ${
      ...
      <motion.button
        ...
        transition={shellMotion}
        className={`absolute inset-y-0 z-10 grid w-10 place-items-center rounded-md text-muted-foreground outline-none focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-[var(--primary)] disabled:opacity-50 ${
          align === "right" ? "right-0" : "left-0"
