...
export function HoldToConfirm({
  ...
  return (
    <button
      ...
      className={`relative isolate inline-grid h-10 place-items-center overflow-hidden rounded-md border border-border bg-card px-4 text-[13px] font-medium text-foreground outline-none select-none focus-visible:ring-2 focus-visible:ring-ring ${
    ...
    >
      ...
      <motion.span
        aria-hidden
        style={{ clipPath }}
        className="absolute inset-0 grid place-items-center bg-foreground px-4 text-primary-foreground"
      >
        <Faces committed={committed} confirmLabel={confirmLabel}>
          {children}
        </Faces>
