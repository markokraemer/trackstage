...
export function SnapCarousel({
  ...
  const button =
    "grid size-7 place-items-center rounded-[6px] border border-border bg-card text-foreground shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(27,30,39,0.06),0_1px_2px_rgba(27,30,39,0.08)] outline-none transition-[background-color,border-color,box-shadow,transform] duration-150 hover:bg-secondary active:translate-y-px active:shadow-[inset_0_1px_2px_rgba(27,30,39,0.06)] focus-visible:border-ring focus-visible:shadow-[0_1px_2px_rgba(27,30,39,0.08),0_10px_20px_-14px_rgba(47,92,224,0.6)]"
  ...
  return (
    <div className={`w-full ${className}`}>
      <div
        ...
        className="relative overflow-hidden rounded-xl py-1.5 outline-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]"
        {...car.viewportProps}
      >
        <motion.div
          {...car.trackProps}
        ...
        <span className="flex items-center gap-[3px]">
          {slides.map((slide, i) => (
            <button
              ...
              className="grid h-[18px] w-[16px] place-items-center rounded-[5px] outline-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]"
            >
              <motion.span
                initial={false}
                animate={
