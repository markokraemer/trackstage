...
export function ScrollSpy({
  ...
  return (
    <nav aria-label={label} className={`w-full ${className}`}>
      <div className="rounded-lg bg-muted/80 p-1 shadow-[inset_0_1px_2px_rgba(27,30,39,0.07)]">
        <ol className="flex [scrollbar-width:none] gap-1 overflow-x-auto [&::-webkit-scrollbar]:hidden">
            ...
            return (
              ...
              >
                ...
                <a
                  ...
                  className="group relative flex h-7 w-full items-center justify-center rounded-[6px] px-2.5 text-[12.5px] outline-none after:pointer-events-none after:absolute after:inset-0 after:rounded-[6px] focus-visible:after:bg-primary/[0.06] focus-visible:after:shadow-[inset_0_0_0_1px_var(--primary)]"
                >
                  <span className="relative grid">
                    <span
                      aria-hidden
                      className="invisible col-start-1 row-start-1 font-medium whitespace-nowrap"
                    >
                      {section.label}
                    </span>
                    <span
