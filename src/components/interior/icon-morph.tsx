...
export function IconMorph({
  ...
  return (
    <motion.button
      ...
      className={`inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-md border border-border bg-card text-[13px] font-medium text-foreground outline-none select-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 ${
        showLabel ? "px-3" : "w-9"
      } ${className}`}
