...
const HIT =
  "outline-none transition-colors duration-150 hover:text-foreground focus-visible:bg-primary/[0.06] focus-visible:text-foreground focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]"
...
export function LogoMarquee({
  ...
  return (
    <section
      aria-label={label}
      className={`relative isolate w-full max-w-full min-w-0 overflow-hidden rounded-xl border border-border bg-card shadow-[0_1px_2px_rgba(27,30,39,0.06),0_4px_10px_-8px_rgba(27,30,39,0.45)] ${className}`}
      {...bind}
    >
      <div
        ref={viewportRef}
        ...
        className="overflow-y-hidden py-2 outline-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]"
      >
        <div
          ref={trackRef}
