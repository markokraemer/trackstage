      ...
      <AnimatePresence initial={false}>
        {activity ? (
          <motion.div
            ...
            className="pointer-events-auto relative overflow-hidden rounded-lg border border-border bg-card shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),0_1px_2px_rgba(27,30,39,0.07),0_16px_36px_-18px_rgba(27,30,39,0.5)]"
          >
            <motion.div
              ref={compactRef}
              ...
              className={`absolute top-0 left-0 flex h-8 w-max items-center gap-1.5 px-2.5 ${face(!expanded)}`}
            >
            ...
            <motion.div
              ...
              transition={reduced ? INSTANT : CROSSFADE}
              style={{ width }}
              className={`absolute top-0 left-0 px-3.5 py-3 ${face(expanded)}`}
            >
              <div className="flex items-center gap-2">
                ...
                {activity.action ? (
                  <button
                    ...
                    className="inline-flex h-[24px] shrink-0 items-center rounded-[6px] border border-border bg-card px-2 text-[11px] font-medium whitespace-nowrap text-foreground shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(27,30,39,0.06),0_1px_2px_rgba(27,30,39,0.08)] transition-[background-color,border-color,box-shadow] duration-150 outline-none select-none hover:bg-secondary focus-visible:border-ring active:translate-y-px"
                  >
                ...
                {onDismiss && phase !== "running" ? (
                  <button
                    ...
                    onClick={onDismiss}
                    className="grid size-[22px] shrink-0 place-items-center rounded-[6px] text-muted-foreground/70 transition-colors duration-150 hover:bg-muted hover:text-foreground focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)] focus-visible:outline-none"
                  >
                    <svg
                      width="10"
                      height="10"
              ...
              {percent !== null && phase !== "error" ? (
                <div className="mt-2.5 flex items-center gap-2 pl-[26px]">
                  <div className="min-w-0 flex-1 rounded-[4px] bg-border/60 p-[2px] shadow-[inset_0_1px_2px_rgba(27,30,39,0.1)]">
                    <div className="relative h-[4px] overflow-hidden rounded-[2px]">
                      <motion.span
                        aria-hidden
                        className="absolute inset-0 block origin-left rounded-[2px] bg-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]"
                        initial={false}
...
function PhaseGlyph({
  ...
  return (
    <span className="grid size-[18px] shrink-0 place-items-center">
      ...
      <motion.span
        className="col-start-1 row-start-1 flex text-status-green-fg"
        initial={false}
        animate={{
