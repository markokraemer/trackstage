  ...
  return (
    <div className={`relative flex w-full justify-center ${className}`}>
      ...
      <button
        ...
        className={`group relative inline-flex h-8 items-center justify-center rounded-md px-3 text-[12.5px] font-medium transition-[background-color,box-shadow,transform] duration-150 outline-none select-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)] ${
          inert
            ? "cursor-default"
            : "cursor-pointer hover:bg-foreground/[0.04] active:translate-y-px"
        }`}
