          ...
          return (
            <div key={i} className={`relative h-12 w-10 ${gap ? "ml-3" : ""}`}>
              <input
                ...
                className={`h-12 w-10 rounded-lg border-2 text-center text-[15px] text-transparent caret-transparent transition-[background-color,border-color,box-shadow] duration-150 outline-none selection:bg-transparent focus-visible:outline-none disabled:opacity-50 ${
                  error
                    ? "border-destructive bg-card"
                    : success
                      ? "border-status-green-dot bg-card"
                      : active
                        ? "border-ring bg-card"
                        : char
              ...
              >
                <AnimatePresence initial={false} mode="popLayout">
                  {char ? (
                    <motion.span
                      ...
                      transition={enter}
                      className="col-start-1 row-start-1 font-mono text-[15px] text-foreground tabular-nums"
                    >
                      {char}
                    </motion.span>
                  ) : null}
                ...
                {active && !char && !disabled ? (
                  <motion.span
                    className="col-start-1 row-start-1 block h-[17px] w-[1.5px] rounded-[1px] bg-foreground/85"
                    initial={{ opacity: 1 }}
                    animate={
