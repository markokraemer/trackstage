    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="relative mt-1.5">
        <input
          ...
          {...fieldProps}
          className={`h-10 w-full rounded-lg border-2 pr-9 pl-3 text-[13px] text-foreground transition-[background-color,border-color,box-shadow] duration-150 outline-none placeholder:text-muted-foreground/70 focus-visible:outline-none disabled:opacity-50 ${
            invalid
              ? "border-destructive bg-card"
              : "border-border bg-muted/70 shadow-[inset_0_1px_2px_rgba(27,30,39,0.07)] focus:border-ring focus:bg-card focus:shadow-none"
          }`}
        />

        <span
          className="pointer-events-none absolute top-1/2 right-3 grid size-3.5 -translate-y-1/2 place-items-center"
          aria-hidden
        >
          <motion.svg
            viewBox="0 0 12 12"
