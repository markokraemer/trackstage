  ...
  return (
    <div className={`w-full ${className}`}>
      <div className="flex items-baseline justify-between gap-3">
        ...
        >
          <motion.span
            className="col-start-1 row-start-1 text-[12px] leading-5 font-medium whitespace-nowrap"
            initial={false}
          ...
          <motion.span
            className="col-start-1 row-start-1 font-mono text-[12px] leading-5 font-medium whitespace-nowrap tabular-nums"
            initial={false}
      ...
      <div
        ...
        aria-valuemax={max}
        {...measured}
        className="mt-2 rounded-[4px] bg-border/60 p-[2px] shadow-[inset_0_1px_2px_rgba(27,30,39,0.1),inset_0_0_0_1px_rgba(27,30,39,0.06)]"
      >
        <div className="relative h-[8px] overflow-hidden rounded-[2px]">
          <motion.span
            aria-hidden
            className="absolute inset-0 block origin-left rounded-[2px] bg-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_0_rgba(27,30,39,0.2)]"
            initial={false}
          ...
          {indeterminate && !reduced ? (
            <motion.span
              aria-hidden
              className="absolute inset-y-0 left-0 block w-2/5 rounded-[2px] bg-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_0_rgba(27,30,39,0.2)]"
