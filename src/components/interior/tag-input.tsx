  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <ul
        ...
        className="relative flex max-h-[116px] min-h-10 list-none flex-wrap items-center gap-1.5 overflow-y-auto overscroll-contain rounded-lg border-2 border-border bg-muted/70 p-[4px] shadow-[inset_0_1px_2px_rgba(27,30,39,0.07)] transition-[background-color,border-color,box-shadow] duration-150 focus-within:border-ring focus-within:bg-card focus-within:shadow-none"
      >
          ...
          {rows.map(({ tag, key }, index) => {
            ...
            return (
              <motion.li
                ...
                className={`flex h-6 max-w-full shrink-0 items-center gap-1 rounded-[6px] border pr-1.5 pl-2 text-[12.5px] transition-[background-color,border-color,box-shadow,color] duration-150 select-none ${
                  lit
                    ? "border-foreground bg-foreground text-primary-foreground shadow-[0_1px_2px_rgba(27,30,39,0.18)]"
                    : "border-border bg-card text-foreground shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(27,30,39,0.06),0_1px_2px_rgba(27,30,39,0.08)]"
                }`}
              >
        ...
        >
          <span
            aria-hidden
            className="pointer-events-none invisible max-w-56 overflow-hidden px-1 text-[12.5px] whitespace-pre"
          >
            {draft || placeholder}
          </span>
          <input
            ...
            spellCheck={false}
            enterKeyHint="done"
            className="absolute inset-0 h-full w-full bg-transparent px-1 text-[12.5px] text-foreground outline-none placeholder:text-muted-foreground/70"
          />
        </motion.li>
      </ul>
      ...
      <div className="mt-1.5 flex items-baseline justify-between gap-3">
        ...
        {max === undefined ? null : (
          <p className="shrink-0 text-[11.5px] text-muted-foreground tabular-nums">
