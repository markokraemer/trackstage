...
export function HideOnScroll({
  ...
  return (
    <div
      className={`relative w-full min-w-0 overflow-hidden rounded-xl border border-border bg-card shadow-[0_1px_2px_rgba(27,30,39,0.06),0_4px_10px_-8px_rgba(27,30,39,0.45)] ${className}`}
    >
      <motion.div
