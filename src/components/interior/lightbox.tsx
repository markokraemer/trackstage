...
const CHROME_BUTTON =
  "grid size-8 place-items-center rounded-md border border-border bg-card text-muted-foreground outline-none transition-[border-color,color,box-shadow] duration-150 hover:border-input hover:text-foreground focus-visible:border-ring focus-visible:shadow-[0_1px_2px_rgba(27,30,39,0.08),0_10px_20px_-14px_rgba(47,92,224,0.6)]"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute inset-0 overflow-hidden outline-none select-none focus-visible:shadow-[inset_0_0_0_1px_var(--primary)] ${
      ...
      >
        <p
          id={titleId}
          className="pointer-events-auto max-w-[65%] truncate rounded-md border border-border bg-card px-2.5 py-1.5 text-[12.5px] text-foreground"
        >
          {caption ?? alt}
        </p>
