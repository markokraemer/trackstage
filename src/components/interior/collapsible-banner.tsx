    ...
    <>
      ...
      >
        <div
          ...
          className={`rounded-lg border border-border bg-card shadow-[0_1px_2px_rgba(27,30,39,0.06),0_4px_10px_-8px_rgba(27,30,39,0.45)] ${className}`}
        >
          <div className="flex items-center gap-2.5 p-2.5">
            <span
              aria-hidden="true"
              className="grid size-[26px] shrink-0 place-items-center rounded-[7px] bg-muted/70 text-muted-foreground shadow-[inset_0_1px_2px_rgba(27,30,39,0.06)]"
            >
              {icon ?? NOTICE_GLYPH}
            </span>
            ...
            {hasBody ? (
              <button
                ...
                className="group flex min-w-0 flex-1 items-center gap-2 rounded-[7px] text-left outline-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]"
              >
                <span
                  id={titleId}
                  className="min-w-0 flex-1 truncate text-[13px] leading-5 font-medium text-foreground"
                >
                  {title}
                </span>
                <motion.span
                  aria-hidden="true"
                  className="flex shrink-0 text-muted-foreground/70 group-hover:text-muted-foreground"
                  initial={false}
            ...
            {dismissible ? (
              <button
                ...
                className="grid size-[26px] shrink-0 place-items-center rounded-[7px] text-muted-foreground/70 transition-colors duration-150 hover:bg-muted hover:text-foreground focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)] focus-visible:outline-none"
              >
                {CLOSE}
              </button>
            ) : null}
          ...
          {hasBody ? (
            ...
            >
              <motion.div
                ...
                className="pr-2.5 pb-2.5 pl-[46px]"
              >
                {description ? (
