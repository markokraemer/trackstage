    ...
    <div className={`w-full ${className}`}>
      <div className="relative pt-[20px]">
        ...
        <motion.label
          ...
          className={`absolute top-[32px] left-3 block cursor-text text-[13px] leading-[16px] select-none ${
            invalid
              ? "text-destructive"
              : raised
      ...
      <div className="mt-1.5 flex h-[16px] items-start gap-3">
        ...
        {maxLength !== undefined ? (
          <span
            aria-hidden
            className="grid shrink-0 justify-items-end font-mono text-[10.5px] leading-[16px] text-muted-foreground/70 tabular-nums"
          >
