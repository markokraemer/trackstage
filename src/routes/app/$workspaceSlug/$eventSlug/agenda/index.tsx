...
export const Route = createFileRoute("/app/$workspaceSlug/$eventSlug/agenda/")({
...
function AgendaPage() {
  ...
  const { event, eventRef, isLoading: eventsPending } = useCurrentEvent()
        ...
        <>
          ...
          */}
          ...
          {event && board ? (
            <PublishAgendaButton
              eventId={event._id}
              workspaceSlug={event.organizationSlug}
