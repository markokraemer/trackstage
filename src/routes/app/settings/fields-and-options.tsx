...
export const Route = createFileRoute("/app/settings/fields-and-options")({
  component: () => (
    <LegacyAppRedirect to={(ref) => appLink.settingsSection(ref, "fields-and-options")} section="settings" />
  ),
})
