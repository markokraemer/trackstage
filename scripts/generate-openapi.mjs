  ...
  const spec = {
    ...
    info: {
      ...
      description: [
        ...
        "| 403 | `ForbiddenError` | Valid key, but missing scope, role, or workspace access — including the read-only demo token attempting a write, or reaching past the demo events. |",
      ...
      securitySchemes: {
        ApiKeyHeader: {
          ...
          description: [
            ...
            "",
            "**Exploring without an account:** `demo-api-token` reads the demo events — and only those — and answers 403 on every write.",
          ].join("\n"),
        },
        BearerToken: {
          type: "http",
